...
function App() {
  ...
  return (
    <>
      <div className="svg fixed items-center justify-center top-0 left-0 z-[100] w-full h-screen overflow-hidden bg-[#000]">
          ...
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            <div className="navbar absolute top-0 left-0 z-[10] w-full py-10 px-10">
              <div className="logo flex gap-7">
                ...
                <h3 className="text-4xl -mt-[8px] text-white leading-none">
                  Rockstar
                </h3>
              </div>
            </div>
            ...
            <div className="imagediv relative overflow-hidden w-full h-screen">
              ...
              <img
                ...
                alt=""
              />
              <div className="text text-white flex flex-col gap-1 absolute top-20 left-1/2 -translate-x-1/2 scale-[1.4] rotate-[-10deg]">
          ...
          <div className="w-full h-screen  flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%]">
              ...
              <div className="rg w-[30%] py-30">
                ...
                <button className="bg-yellow-500 text-black px-10 py-10 text-4xl mt-10">
                  Download Now
                </button>
              </div>
            </div>
